...
<section class="category">
    ...
    <div class="box-container" >
        ...
        <a href="http://127.0.0.1:8000/drawers" class="box" style="background-color: #244d4d; ">
            <img src="image/icons8-bureau-white.png" alt="">
            <h3 style="color: #fff">Drawers</h3>
        </a>
...
<section class="products">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/drawer-1.png')}}" alt=""style="height: 200px;width:200px ; margin-top:5rem;margin-left:5rem">
            </div>
            <div class="content">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/drawer-2.png')}}" alt="" style="height: 200px;width:200px ; margin-top:5rem;margin-left:5rem">
            </div>
            <div class="content">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/drawer-3.png')}}" alt=""style="height: 200px;width:200px ; margin-top:5rem;margin-left:5rem">
            </div>
            <div class="content">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/drawer-4.png')}}" alt=""style="height: 200px;width:200px ; margin-top:5rem;margin-left:5rem">
            </div>
            <div class="content">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/drawer-5.png')}}"alt=""style="height: 200px;width:200px ; margin-top:5rem;margin-left:5rem">
            </div>
            <div class="content">
                <div class="price">$160.00</div>
                <h3>Bedside Drawer</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
