...
<section class="category">
    ...
    <div class="box-container" >
        ...
        <a href="http://127.0.0.1:8000/mirrors" class="box" style="background-color: #244d4d; ">
            <img src="image/icons8-mirror-white.png" alt="">
            <h3 style="color: #fff">Mirrors</h3>
        </a>
...
<section class="products">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/mirror-1.png')}}" alt=""style="height: 300px;width:200px ; margin-top:1rem;margin-left:5rem">
            </div>
            <div class="content">
                <div class="price">$150.00</div>
                <h3>Stylish Mirror</h3>
                <div class="stars">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/mirror-2.png')}}" alt="" style="height: 300px;width:300px ; margin-top:1rem;margin-left:0rem">
            </div>
            <div class="content">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/mirror-3.png')}}" alt=""style="height: 300px;width:200px ; margin-top:1rem;margin-left:5rem">
            </div>
            <div class="content">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/mirror-4.png')}}" alt=""style="height: 300px;width:200px ; margin-top:1rem;margin-left:5rem">
            </div>
            <div class="content">
