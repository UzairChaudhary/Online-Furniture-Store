...
<section class="category">
    ...
    <div class="box-container" >
        ...
        <a href="http://127.0.0.1:8000/chairs" class="box" style="background-color: #244d4d; ">
            <img src="image/icons8-lounge-chair-white.png" alt="">
            <h3 style="color: #fff">Chairs</h3>
        </a>
...
<section class="products">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/chair-1.png')}}" alt=""style="height: 200px;width:200px ; margin-top:5rem;margin-left:5rem">
            </div>
            <div class="content">
                <div class="price">$150.00</div>
                <h3 class="title">Comfortable Chair</h3>
                <div class="stars">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/chair-2.png')}}" alt="" style="height: 200px;width:200px ; margin-top:5rem;margin-left:5rem">
            </div>
            <div class="content">
                <div class="price">$140.00</div>
                <h3 class="title">Office Chair</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/chair-3.png')}}" alt=""style="height: 200px;width:200px ; margin-top:5rem;margin-left:5rem">
            </div>
            <div class="content">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/chair-4.png')}}" alt=""style="height: 200px;width:200px ; margin-top:5rem;margin-left:5rem">
            </div>
            <div class="content">
                <div class="price">$120.00</div>
                <h3 class="title">Wooden Chair</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/chair-5.png')}}"alt=""style="height: 200px;width:200px ; margin-top:5rem;margin-left:5rem">
            </div>
            <div class="content">
                <div class="price">$160.00</div>
                <h3 class="title">Modern Chair</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
