...
<section class="category">
    ...
    <div class="box-container" >
        ...
        <a href="http://127.0.0.1:8000/tables" class="box"style="background-color: #244d4d; ">
            <img src="image/icons8-coffee-table-white.png" alt="">
            <h3 style="color: #fff">Tables</h3>
        </a>
...
<section class="products">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/table-1.png')}}" alt=""style="height: 200px;width:200px ; margin-top:5rem;margin-left:5rem">
            </div>
            <div class="content">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/table-2.png')}}" alt="" style="height: 250px;width:200px ; margin-top:5rem;margin-left:5rem">
            </div>
            <div class="content">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/table-3.png')}}" alt=""style="height: 200px;width:200px ; margin-top:5rem;margin-left:5rem">
            </div>
            <div class="content">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{asset('image/table-4.png')}}" alt=""style="height: 200px;width:200px ; margin-top:5rem;margin-left:5rem">
            </div>
            <div class="content">
